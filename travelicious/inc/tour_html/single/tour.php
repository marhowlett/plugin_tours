...
if ( ! function_exists( 'boldthemes_get_tour_similiar_tours_tab_html' ) ) {
	function boldthemes_get_tour_similiar_tours_tab_html( $type = '', $gap = '', $columns = '' ) {  
            if ( !empty( BoldThemesFrameworkTemplate::$tours_similiar ) ) {                
                ...
                ?>
                    <div class="btTourList <?php echo $tour_list_type;?> <?php echo $tour_list_gap;?>  <?php echo $tour_list_columns;?>" style="padding-top:0em;">
                        <?php 
                            ...
                            if ( $s == 0 ){
                                ?>
                                    <div class="btTourList bt_bb_tour_list_empty bt_bb_tour_list_similiar_empty">
                                        <p><?php esc_html_e( 'Sorry! There are no similiar tours.', 'bt_plugin' )?></p>
                                    </div>
                                <?php
                            }
                        ?>
